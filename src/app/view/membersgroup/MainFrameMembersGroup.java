...
import static app.view.membersgroup.EditMembersGroup.id;
 ...
 * @author Engkoi Zidac
 */
public final class MainFrameMembersGroup extends javax.swing.JInternalFrame {

    public static AddMembersGroup frmNew;
    public static EditMembersGroup frmEdit;

    MemberGroupController Controller = new MemberGroupController();

    public MainFrameMembersGroup() {
        initComponents();
        PopulateData();
    }
    ...
    public void ShowFrmNew() {
        frmNew = new AddMembersGroup(this, true);
        frmNew.setVisible(true);
    }

    public void ShowFrmEdit() {
        frmEdit = new EditMembersGroup(this, true);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtsearch, javax.swing.GroupLayout.DEFAULT_SIZE, 695, Short.MAX_VALUE)
                .addGap(21, 21, 21))
        );
    ...
    private void AddButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton1ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            EditMembersGroup.id = Integer.valueOf(id);
            ShowFrmEdit();
        }
    ...
    private void AddButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton2ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            switch (i) {
                case 0:
                    Controller.setGroupId(Integer.valueOf(id));
                    Controller.Remove();
                    PopulateData();
