...
public class AddMembersGroup extends javax.swing.JDialog {

    public static MainFrameMembersGroup frmParent;
    static Statement stmt;
    MemberGroupController Controller = new MemberGroupController();

    public AddMembersGroup(MainFrameMembersGroup parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(AddMembersGroup.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            AddMembersGroup dialog = new AddMembersGroup(frmParent, true);
