 ...
 * @author Engkoi Zidac
 */
public class EditMembersGroup extends javax.swing.JDialog {

    public static MainFrameMembersGroup frmParent;
    static Statement stmt;
    MemberGroupController Controller = new MemberGroupController();
    public static int id;

    public EditMembersGroup(MainFrameMembersGroup parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(EditMembersGroup.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            EditMembersGroup dialog = new EditMembersGroup(frmParent, true);
