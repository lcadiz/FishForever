...
public class AssignGroup extends javax.swing.JDialog {
    ...
    public AssignGroup(UserAccountManage parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cmdassign.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/innn.png"))); // NOI18N
        ...
        cmdunassign.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/outtt.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        invokeLater(() -> {
            AssignGroup dialog = new AssignGroup(frmParent, true);
