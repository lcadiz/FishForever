...
public class EditUserAccount extends javax.swing.JDialog {

    public static UserAccountManage frmParent;
    static Statement stmt;
    static int userid;

    public EditUserAccount(UserAccountManage parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    public void populateFields() {
        ...
        String createString;
        createString = "SELECT full_name, user_name, password, gender "
                + "FROM user "
    ...
    public static void edit_userinfo(String fname, String uname, int gender) {
        Connection conn = getConnection();
        String createString;
        createString = "UPDATE user SET full_name='" + fname + "',user_name='" + uname + "',gender=" + gender + " "
                + "WHERE user_id=" + userid;
    ...
    public static void main(String args[]) {
        invokeLater(() -> {
            EditUserAccount dialog = new EditUserAccount(frmParent, true);
