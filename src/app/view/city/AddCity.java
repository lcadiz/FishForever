...
public class AddCity extends javax.swing.JDialog {
    ...
    public static int ComboBoxProvinceId;

    public AddCity(MainFrameCity parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        if (txtdesc.getText().isEmpty() == true) {
            ...
            Controller.setProvinceId(ComboBoxProvinceId);
            Controller.Add();
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(AddCity.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            AddCity dialog = new AddCity(frmParent, true);
