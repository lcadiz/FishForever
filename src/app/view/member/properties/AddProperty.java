...
public class AddProperty extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddProperty dialog = new AddProperty(frmParent, true);
