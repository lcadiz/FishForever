 ...
 * @author Engkoi Zidac
 */
public final class MainFrameProvince extends javax.swing.JInternalFrame {

    public static AddProvince frmNew;
    public static EditProvince frmEdit;

    ProvinceController Controller = new ProvinceController();

    public MainFrameProvince() {
        initComponents();
        PopulateData();
    }
    ...
    public void ShowFrmNew() {
        frmNew = new AddProvince(this, true);
    ...
    private void AddButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton2ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            switch (i) {
                case 0:
                    Controller.setProvinceId(Integer.valueOf(id));
                    Controller.Remove();
                    PopulateData();
