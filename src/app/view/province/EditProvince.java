 ...
 * @author Engkoi Zidac
 */
public class EditProvince extends javax.swing.JDialog {

    public static MainFrameProvince frmParent;
    static Statement stmt;
    ProvinceController Controller = new ProvinceController();
    public static int id;

    public EditProvince(MainFrameProvince parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
        setLocationRelativeTo(this);
        getRootPane().setDefaultButton(cmdadd);
        Controller.setProvinceId(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(EditProvince.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            EditProvince dialog = new EditProvince(frmParent, true);
