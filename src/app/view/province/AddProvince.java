...
public class AddProvince extends javax.swing.JDialog {

    public static MainFrameProvince frmParent;
    static Statement stmt;
    ProvinceController Controller = new ProvinceController();

    public AddProvince(MainFrameProvince parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(AddProvince.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            AddProvince dialog = new AddProvince(frmParent, true);
