...
public class AddBarangay extends javax.swing.JDialog {

    public static MainFrameBarangay frmParent;
    static Statement stmt;
    BarangayController Controller = new BarangayController();
    public static int ComboBoxCityId;

    public AddBarangay(MainFrameBarangay parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        if (txtdesc.getText().isEmpty() == true) {
            ...
            Controller.setCityId(ComboBoxCityId);
            Controller.Add();
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(AddBarangay.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            AddBarangay dialog = new AddBarangay(frmParent, true);
