 ...
 * @author Engkoi Zidac
 */
public final class MainFrameBarangay extends javax.swing.JInternalFrame {

    public static AddBarangay frmNew;
    public static EditBarangay frmEdit;
    private static int ComboBoxCityId, ComboBoxProvinceId;
   
    BarangayController Controller = new BarangayController();
    CityController CityController = new CityController();
    ProvinceController ProvinceController = new ProvinceController();

    public MainFrameBarangay() {
        initComponents();
    ...
    public void PopulateData() {
        Controller.PopulateTableData(Table, ComboBoxCityId, txtsearch.getText());
    }

    public void ShowFrmNew() {
        frmNew = new AddBarangay(this, true);
        frmNew.setVisible(true);
    }

    public void ShowFrmEdit() {
        frmEdit = new EditBarangay(this, true);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(ComboProvince, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 1256, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        if (ComboBoxCityId == 0) {
            ...
            AddBarangay.ComboBoxCityId = ComboBoxCityId;
            ShowFrmNew();
        }
    ...
    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            EditBarangay.id = Integer.valueOf(id);
