 ...
 * @author Engkoi Zidac
 */
public class EditBarangay extends javax.swing.JDialog {
    ...
    public EditBarangay(MainFrameBarangay parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
        setLocationRelativeTo(this);
        getRootPane().setDefaultButton(cmdadd);
        Controller.setBarangayId(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(EditBarangay.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            EditBarangay dialog = new EditBarangay(frmParent, true);
