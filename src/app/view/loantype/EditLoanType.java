 ...
 * @author Engkoi Zidac
 */
public class EditLoanType extends javax.swing.JDialog {
    ...
    public EditLoanType(MainFrameLoanType parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
        setLocationRelativeTo(this);
        getRootPane().setDefaultButton(cmdadd);
        Controller.setLoanTypeId(id);
    ...
    void PopulateFields() {
        ...
        txtinterest.setText(valueOf(Controller.getInterestRate()));
        txtterm.setText(valueOf(Controller.getTerm()));
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtdesc, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(EditLoanType.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            EditLoanType dialog = new EditLoanType(frmParent, true);
