...
import static app.view.loantype.EditLoanType.id;
 ...
 * @author Engkoi Zidac
 */
public final class MainFrameLoanType extends javax.swing.JInternalFrame {

    public static AddLoanType frmNew;
    public static EditLoanType frmEdit;

    LoanTypeController Controller = new LoanTypeController();

    public MainFrameLoanType() {
        initComponents();
        PopulateData();
    }
    ...
    public void ShowFrmNew() {
        frmNew = new AddLoanType(this, true);
        frmNew.setVisible(true);
    }

    public void ShowFrmEdit() {
        frmEdit = new EditLoanType(this, true);
    ...
    private void initComponents() {
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Description ", "Default Interest Rate", "Default Term"
            }
        ) {
    ...
    private void AddButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton1ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            EditLoanType.id = Integer.valueOf(id);
            ShowFrmEdit();
        }
    ...
    private void AddButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton2ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            switch (i) {
                case 0:
                    Controller.setLoanTypeId(Integer.valueOf(id));
                    Controller.Remove();
                    PopulateData();
