 ...
 * @author Engkoi Zidac
 */
public final class MainFrameCollateral extends javax.swing.JInternalFrame {

    public static AddCollateral frmNew;
    public static EditCollateral frmEdit;
    private static int ComboBoxCollateralId, ComboBoxProvinceId;
   
    CollateralController Controller = new CollateralController();

    public MainFrameCollateral() {
        initComponents();
        PopulateData();
    }
    ...
    public void ShowFrmNew() {
        frmNew = new AddCollateral(this, true);
        frmNew.setVisible(true);
    }

    public void ShowFrmEdit() {
        frmEdit = new EditCollateral(this, true);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 793, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void EditButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditButtonActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            EditCollateral.id = Integer.valueOf(id);
    ...
    private void AddButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton2ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            switch (i) {
                case 0:
                    Controller.setCollateralId(Integer.valueOf(id));
                    Controller.Remove();
                    PopulateData();
