...
public class AddCollateral extends javax.swing.JDialog {
    ...
    public static MainFrameCollateral frmParent;
    static Statement stmt;
    CollateralController Controller = new CollateralController();


    public AddCollateral(MainFrameCollateral parent, boolean modal) {
        frmParent = parent;
        this.setModal(modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(AddCollateral.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
